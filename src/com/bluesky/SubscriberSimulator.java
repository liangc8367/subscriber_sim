...
/**
 * a SU simulator, also a call processor, signaling processor
 * running in the a executor/thread context,
 * composed of a state machine,
 * providing helper methods for state machine to use
 *
